                    ...
                    <div class="card-body msg_card_body dlab-scroll" id="dlab_W_Contacts_Body3">
                        <div class="d-flex justify-content-start mb-4">
                            <div class="img_cont_msg">
                                <img src="{{ asset('assets/images/avatar/1.jpg') }}" class="rounded-circle user_img_msg"
                                    alt="" />
                            </div>
                        ...
                        <div class="d-flex justify-content-end mb-4">
                            ...
                            <div class="img_cont_msg">
                                <img src="{{ asset('assets/images/avatar/2.jpg') }}" class="rounded-circle user_img_msg"
                                    alt="" />
                            </div>
                        </div>
                        <div class="d-flex justify-content-start mb-4">
...
<div class="dlabnav">
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="{{ route('dkeluarga.index') }}" class="ai-icon" aria-expanded="false">
                     <i class="flaticon-017-clipboard"></i>
        ...
        <div class="copyright">
            ...
            <p class="fs-12">Made with <span class="heart"></span> by Tim Bayangan</p>
        </div>
    </div>
</div>
<!--**********************************
