                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-6">
                                <div class="card-bx bg-blue">
                                    <img class="pattern-img" src="{{
                                            asset(
                                                'assets/images/pattern/pattern6.png'
                                            )
                                        }}" alt="" />
                                ...
                                <div class="row mt-xl-0 mt-4">
                                    <div class="col-md-6">
                                        ...
                                        <span>Lorem ipsum dolor sit amet,
                                            consectetur adipiscing elit psu
                                            olor</span>
                                        <ul class="card-list mt-4">
                                            <li>
                                                <span class="bg-blue circle"></span>Account<span>20%</span>
                                            </li>
                                            <li>
                                                <span class="bg-success circle"></span>Services<span>40%</span>
                                            </li>
                                            <li>
                                                <span class="bg-warning circle"></span>Restaurant<span>15%</span>
                                            </li>
                                            <li>
                                                <span class="bg-light circle"></span>Others<span>15%</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <div class="card-header pb-0 border-0">
                        ...
                        <ul class="card-list">
                            <li class="justify-content-end">
                                Income<span class="bg-success circle me-0 ms-2"></span>
                            </li>
                            <li class="justify-content-end">
                                Outcome<span class="bg-danger circle me-0 ms-2"></span>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-xl-3 col-xxl-7">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="mt-3 mb-3">
                            Recent Friend<a href="javascript:void(0);"
                                class="fs-16 float-end text-secondary font-w600">See More</a>
                        </h4>
                        <ul class="user-list">
                            <li>
                                <img src="{{
                            ...
                            <li>
                                <img src="{{
                                        asset('assets/images/avatar/2.jpg')
                                    }}" alt="" />
                            </li>
                            <li>
                                <img src="{{
                                        asset('assets/images/avatar/3.jpg')
                                    }}" alt="" />
                            </li>
                            <li>
                                <img src="{{
                                        asset('assets/images/avatar/4.jpg')
                                    }}" alt="" />
                            </li>
                            <li>
                                <img src="{{
                                        asset('assets/images/avatar/5.jpg')
                                    }}" alt="" />
                            </li>
                            <li>
                                <img src="{{
                                        asset('assets/images/avatar/6.jpg')
                                    }}" alt="" />
                            </li>
                        </ul>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="progress default-progress">
                            <div class="progress-bar bg-gradient-1 progress-animated" style="width: 45%; height: 20px"
                                role="progressbar">
                        ...
                        <div class="progress default-progress mt-4">
                            <div class="progress-bar bg-gradient-2 progress-animated" style="width: 70%; height: 20px"
                                role="progressbar">
                        ...
                        <div class="progress default-progress mt-4">
                            <div class="progress-bar bg-gradient-3 progress-animated" style="width: 35%; height: 20px"
                                role="progressbar">
                        ...
                        <div class="progress default-progress mt-4">
                            <div class="progress-bar bg-gradient-4 progress-animated" style="width: 95%; height: 20px"
                                role="progressbar">
            ...
            <div class="col-xl-6 col-xxl-7">
                <div class="card">
                    <div class="card-header d-flex flex-wrap border-0 pb-0">
                        ...
                        <a href="javascript:void(0)" class="btn btn-rounded btn-md btn-primary mr-3 me-3"><i
                                class="las la-download scale5 me-3"></i>Download
                            Report</a>
                        <div class="dropdown">
                            <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown"
                                aria-expanded="false">
                    ...
                    <div class="card-body pb-2">
                        <div class="d-sm-flex d-block">
                            ...
                            <ul class="card-list d-flex mt-sm-0 mt-3">
                                <li class="me-3">
                                    <span class="bg-success circle"></span>Income
                                </li>
                                <li>
                                    <span class="bg-danger circle"></span>Outcome
                                </li>
                            </ul>
                        </div>
                                ...
                                <table class="table table-responsive-md card-table transactions-table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="fs-16 font-w600 mb-0">
                                                    <a href="javascript:void(0);" class="text-black">XYZ Store ID</a>
                                                </h6>
                                            ...
                                            <td>
                                                <span class="fs-16 text-black font-w600">+$5,553</span>
                                            </td>
                                            <td>
                                                <span
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="fs-16 font-w600 mb-0">
                                                    <a href="javascript:void(0);" class="text-black">Chef Renata</a>
                                                </h6>
                                            ...
                                            <td>
                                                <span class="fs-16 text-black font-w600">-$167</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="fs-16 font-w600 mb-0">
                                                    <a href="javascript:void(0);" class="text-black">Cindy Alexandro</a>
                                                </h6>
                                                <span class="fs-14">Transfer</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="fs-16 font-w600 mb-0">
                                                    <a href="javascript:void(0);" class="text-black">Paipal</a>
                                                </h6>
                                                <span class="fs-14">Transfer</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="fs-16 font-w600 mb-0">
                                                    <a href="javascript:void(0);" class="text-black">Hawkins Jr.</a>
                                                </h6>
                                                <span class="fs-14">Cashback</span>
                                            </td>
                                            <td>
                    ...
                    <div class="col-xl-12">
                        <div class="card coin-card">
                            <div class="card-body d-sm-flex d-block align-items-center">
                                ...
                                <div>
                                    <h3 class="text-white">
                                        Get managed by Dompet’s Virtual
                                        Assistant
                                    </h3>
                                    <p>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="me-auto">
                                        ...
                                        <p class="fs-16 mb-0 mt-2">
                                            <span class="text-danger">-0,8% </span>from last month
                                        </p>
                                    </div>
...
<script src="{{
        asset('assets/vendor/nouislider/nouislider.min.js')
    }}"></script>
