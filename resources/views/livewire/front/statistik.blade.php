            ...
            <div class="row gy-4">
                ...
                @if ($show)
                    <div class="col-lg-9 order-lg-1">
                        ...
                        <br>
                        <div class="grid grid-view projects-masonry shop mb-5 mt-4">
                            <div class="row gx-md-8 gy-10 gy-md-13 isotope">
                            ...
                            <ul class="list-unstyled ps-0">
                                ...
                                <li class="mb-1">
                                    ...
                                    <div class="collapse mt-1" id="bantuan-collapse" style="">
                                        <ul class="btn-toggle-nav list-unstyled ps-2">
                                            <li><span style="cursor:pointer" wire:click="statistik(22)"
                                                    class="link-body">Penerima Bantuan
                                                    Penduduk</span></li>
                                            <li><span style="cursor:pointer" wire:click="statistik(23)"
            ...
            window.addEventListener('penerima', event => {
                $(document).ready(function() {
                    ...
                    penerima.forEach(dataItem => {
                        ...
                        dataSource.push([
                            dataItem.program, dataItem.nama_peserta, alamat
                        ]);
                    });
