                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-xxl-7">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="user-bx">
                                    <img src="{{ asset('assets/images/profile/small/pic1.jpg') }}" alt="">
                                    <div>
                                ...
                                <ul class="user-list">
                                    <li><img src="{{ asset('assets/images/avatar/1.jpg') }}" alt=""></li>
                                    <li><img src="{{ asset('assets/images/avatar/2.jpg') }}" alt=""></li>
                                    <li><img src="{{ asset('assets/images/avatar/3.jpg') }}" alt=""></li>
                                    <li><img src="{{ asset('assets/images/avatar/4.jpg') }}" alt=""></li>
                                    <li><img src="{{ asset('assets/images/avatar/5.jpg') }}" alt=""></li>
                                    <li><img src="{{ asset('assets/images/avatar/6.jpg') }}" alt=""></li>
                                </ul>
                                        ...
                                        <table class="table table-responsive-md card-table transactions-table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span
                                                            class="text-light fs-16 font-w500 text-end d-block">Pending</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
